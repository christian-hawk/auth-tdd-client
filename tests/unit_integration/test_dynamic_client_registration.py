...
class DynamicClientRegistration(TestCase):
    ...
    def test_if_registration_exists(self):
        ...
        self.assertTrue(
            hasattr(client_handler, 'registration')
        )
    ...
    def test_if_register_client_receives_params(self):
        ...
        self.assertTrue(
            inspect.getfullargspec(ClientHandler.register_client).args == expected_args,
    ...
    def test_if_class_has_initial_expected_attrs(self):
        ...
        self.assertTrue(
            all(attr in ClientHandler.__dict__.keys() for attr in initial_expected_attrs),
    ...
    def test_if_discover_receives_params(self):
        ...
        self.assertTrue(
            inspect.getfullargspec(ClientHandler.discover).args == expected_args,
    ...
    def test_discover_should_not_return_none_when_non_existant_config(self):
        self.assertIsNotNone(ClientHandler.discover(ClientHandler,'https://google.com'))
    ...
    def test_discover_should_return_valid_dict(self):
        ...
        op_data = ClientHandler.discover(ClientHandler,'https://t1.techno24x7.com')

        self.assertTrue(
            main_keys <= set(op_data),
    ...
    def test_if_get_client_dict_receives_params(self):
        expected_args = ['self']
        self.assertTrue(
            inspect.getfullargspec(ClientHandler.get_client_dict).args == expected_args,
    ...
    def test_get_client_dict_should_return_a_dict(self):
        self.assertIsInstance(
            ClientHandler.get_client_dict(ClientHandler),
            dict,
            'get_client_dict is not returning a dict'
        )
    ...
    def test_class_init_should_have_docstring(self):
        self.assertTrue(
            ClientHandler.__init__.__doc__,
