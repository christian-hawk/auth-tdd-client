...
OP_DATA_DICT_RESPONSE = {
    ...
    'https://t1.techno24x7.com/oxauth/restv1/revoke',
    'introspection_endpoint':
    'https://t1.techno24x7.com/oxauth/restv1/introspection',
    ...
    'https://t1.techno24x7.com/oxauth/restv1/authorize',
    'service_documentation':
    'http://gluu.org/docs',
    'id_generation_endpoint':
    'https://t1.techno24x7.com/oxauth/restv1/id',
    'claims_supported': [
        'street_address', 'country', 'zoneinfo', 'birthdate', 'role', 'gender',
        'formatted', 'user_name', 'phone_mobile_number', 'preferred_username',
        'locale', 'inum', 'updated_at', 'nickname', 'email', 'website',
        'email_verified', 'profile', 'locality', 'phone_number_verified',
        'given_name', 'middle_name', 'picture', 'name', 'phone_number',
    ...
    'scope_to_claims_mapping': [{
        ...
        'address': [
            'formatted', 'postal_code', 'street_address', 'locality',
            'country', 'region'
        ]
    }, {
    ...
    True,
    'token_endpoint':
    'https://t1.techno24x7.com/oxauth/restv1/token',
    ...
    'userinfo_endpoint':
    'https://t1.techno24x7.com/oxauth/restv1/userinfo',
    'op_tos_uri':
    ...
    'clientinfo_endpoint':
    'https://t1.techno24x7.com/oxauth/restv1/clientinfo',
    'request_object_signing_alg_values_supported': [
        'none', 'HS256', 'HS384', 'HS512', 'RS256', 'RS384', 'RS512', 'ES256',
        'ES384', 'ES512'
    ],
    'request_object_encryption_alg_values_supported':
    ['RSA1_5', 'RSA-OAEP', 'A128KW', 'A256KW'],
    'session_revocation_endpoint':
    'https://t1.techno24x7.com/oxauth/restv1/revoke_session',
    'check_session_iframe':
    'https://t1.techno24x7.com/oxauth/opiframe.htm',
    'scopes_supported': [
        'address', 'openid', 'clientinfo', 'user_name', 'profile',
        'https://t1.techno24x7.com/oxauth/restv1/uma/scopes/scim_access',
        'uma_protection', 'permission', 'revoke_session', 'oxtrust-api-write',
        'oxtrust-api-read', 'phone', 'mobile_phone', 'oxd',
        'super_gluu_ro_session', 'email',
        'https://t1.techno24x7.com/oxauth/restv1/uma/scopes/passport_access'
    ],
    'backchannel_logout_supported':
    True,
    'acr_values_supported': [
        'simple_password_auth', 'passport_saml',
    ...
    'https://t1.techno24x7.com/oxauth/restv1/end_session',
    'revocation_endpoint':
    'https://t1.techno24x7.com/oxauth/restv1/revoke',
    'backchannel_authentication_endpoint':
    'https://t1.techno24x7.com/oxauth/restv1/bc-authorize',
    ...
    True,
    'jwks_uri':
    'https://t1.techno24x7.com/oxauth/restv1/jwks',
    ...
    'https://t1.techno24x7.com/oxauth/restv1/register',
