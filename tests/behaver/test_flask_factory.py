...
class TestFlaskApp(TestCase):
    ...
    def test_create_app_should_be_inokable(self):
        self.assertEqual(
            hasattr(clientapp.create_app, '__call__'),
            True,
    ...
    def test_if_app_has_secret_key(self):
        self.assertTrue(
            hasattr(clientapp.create_app(),'secret_key'),
    ...
    def test_if_oauth_is_app_extension(self):
        self.assertTrue(
            'authlib.integrations.flask_client' in clientapp.create_app().extensions
    
        )

    def test_if_settings_py_exists(self):
        self.assertTrue(
            os.path.exists('clientapp/config.py'),
    ...
    def test_if_op_client_id_exists_in_app_configuration(self):
        self.assertTrue(
            'OP_CLIENT_ID' in clientapp.create_app().config,
            'No OP_CLIENT_ID in app.config'
        )

    def test_if_clientapp_has_cfg(self):
        self.assertTrue(
            hasattr(clientapp, 'cfg')
        )
    ...
    def test_if_OP_CLIENT_ID_is_equal_cfg_CLIENT_ID(self):
        self.assertEqual(
            clientapp.create_app().config['OP_CLIENT_ID'],
            clientapp.cfg.CLIENT_ID
        )

    def test_if_OP_CLIENT_SECRET_exists_in_app_configuration(self):
        self.assertTrue(
            'OP_CLIENT_SECRET' in clientapp.create_app().config,
