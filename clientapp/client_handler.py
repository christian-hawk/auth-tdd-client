...
class ClientHandler:
    ...
    def __init__(self, op_url: str, client_url: str):
        ...
        self.reg_info = self.register_client(op_data=self.op_data,
    ...
    def register_client(self,
                        op_data: Optional[dict] = op_data,
                        client_url: Optional[str] = __client_url) -> dict:
    ...
    def discover(self,
                 op_url: Optional[str] = __op_url,
                 disc: discovery = discovery) -> dict:
